...
- random 1D Clifford+T brickwork circuits
- Trotterized nonintegrable Ising dynamics
...
The argument is the time budget in seconds per method and case. The current benchmark records only runtime, estimated memory, and absolute error. Results are written to `results/benchmark_v1.csv`.
